$(function() {
	//获取右侧购物栏
	$("#rightcar-box").load("D-common.html .rightcar", function() {	
	...
	//获取头部，尾部样式
	$("#landing-box").load("D-common.html .contener", function() {
		//登陆改变值
	...
	//logo开始
	$("#logo-box").load("D-common.html .contener1", function() {
		//car效果
	...
	//subnav二级导航开始
	$("#subnav-box").load("D-common.html .subnav-main", function() {
	...
	//footer开始
	$("#footer-box").load("D-common.html .footer-main", function() {	
	});
	//小广告时间
	$("#adlet-box").load("D-common.html .adlet-d", function() {	
		show();
		function show(){
			setTimeout(function(){
