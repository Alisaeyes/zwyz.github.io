$(function() {
	//获取右侧购物栏
	$("#rightcar-box").load("L-common.html .rightcar", function() {	
	...
	//获取头部，尾部样式
	$("#landing-box").load("L-common.html .contener", function() {
		//登陆改变值
	...
	//logo开始
	$("#logo-box").load("L-common.html .contener1", function() {
		//car效果
	...
	//subnav二级导航开始
	$("#subnav-box").load("L-common.html .subnav-main", function() {
		$(".subnav-menu-li1").hover(function(){
			$(".subnav-menu-li1").addClass("active");
		},function(){
			$(".subnav-menu-li1").removeClass("active");
		});
		$(".subnav-menu-li2").hover(function(){
			$(".subnav-menu-clear").stop().slideDown();
			$(".subnav-menu-li2").find("span").css({"background":"url(img/index/mainnav.png) no-repeat right -20px"});
		},function(){
			$(".subnav-menu-clear").stop().slideUp();
			$(".subnav-menu-li2").find("span").css({"background":"url(img/index/mainnav.png) no-repeat right -10px"});
		});
	...
	//footer开始
	$("#footer-box").load("L-common.html .footer-main", function() {	
	});
	//小广告时间
	$("#adlet-box").load("L-common.html .adlet-d", function() {	
		show();
		function show(){
			setTimeout(function(){
